...
{
	public partial class IntervalMainViewController : UITableViewController
	{
		public IntervalMainViewController (IntPtr handle) : base (handle)
		{
		}
		...
		public override void PrepareForSegue (UIStoryboardSegue segue, NSObject sender)
		{
			if (segue.Identifier == "SegueDetail") { // set in Storyboard
				var navctlr = (IntervalDetailViewController) segue.DestinationViewController;
				if (navctlr != null) {
		...
		public void CreateTask () {
			...
			var detail = (IntervalDetailViewController) Storyboard.InstantiateViewController("detail");
